...
const RecipeCard = (props: RecipeCardProps) => {
 //console.log(props.recipe.image)
  return (
    <div className="bg-gray-100 p-4 w-[90%] rounded-lg shadow-md mb-4 flex flex-col items-start self-center">
      <div className="grid grid-cols-2">
        <h2 className="col-span-1 text-2xl font-bold mb-2">{props.recipe.name}</h2>
        <h3 className="col-start-1 text-xl font-semibold mb-1">
          Servings: {props.recipe.servings}
        </h3>
        <h3 className="col-start-1 text-xl font-semibold mb-1">Ingredients:</h3>
